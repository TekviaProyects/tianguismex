<div class="contenidoCroquis">
  <h1>Croquis</h1>
  <div class="buscadorCroquis busqueda" id="busquedaCroquis">
    <div class="ui calendar" id="fechaCroquis">
      <div class="ui input left icon" id="cosa1">
        <i class="calendar icon"></i>
        <input type="text" placeholder="Fecha">
      </div>
    </div>
    <div class="ui selection dropdown" id="selectorCroquis">
    ...
    <button type="button" name="button" id="btnCroquis">Buscar</button>
  ...
  <input type="hidden" id="fechaActual" name="" value="">
  <div class="croquisSvg">
  ...
  <div class="ui modal" id="modalCroquis">
    <div class="header">
      Datos del locatario
    </div>
    <div class="content">
      <h4>Nombre</h4>
      <span id="nombreLabel"></span>
      <h4>Correo</h4>
      <span id="correoLabel"></span>
      <h4>Celular</h4>
      <span id="celularLabel"></span>
      <h4>Domicilio</h4>
      <span id="domicilioLabel"></span>
    </div>
  </div>
</div>

<script src="assets/js/funcionesCroquis.js" charset="utf-8"></script>
