...
<html>
  ...
  <body>
    ...
    <main>
      <section id="pago">
        <div class="ui link cards" id="tiposLocal">
          ...
          <div class="card" id="tarjetaNormal">
            <div class="content">
          ...
          <div class="card media" id="tarjetaClass">
            <div class="content">
          ...
          <div class="card" id="tarjetaUltra">
            <div class="content">
        ...
        <div class="ui segment croquis" id="calendarioLocal">
    ...
    <div class="terminos">
      <a href="../resources/TerminosyCondicionesMercadito.pdf" target="_blank">Terminos y condiciones</a>
    </div>
