  ...
  <body>
    ...
    <main>
      ...
      <div class="ui segment" id="contenido">
        <h3>Ubicacion</h3>
        <select class="ui search dropdown" id="estadoSelec">
        ...
        <h3>Tianguis</h3>
        <select class="ui search dropdown disabled" id="tianguisSelec">
          <option value=""></option>
          <option value="MPDS">Mercadito puerta del sol</option>
        </select>
      </div>
    </main>
    <div class="terminos">
