...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../../assets/css/rentarEstilos.css">
  </head>
  <body>
    ...
    <div class="ui icon message" id="mensaje">
      <i class="shopping basket icon"></i>
      <div class="content">
        <p class="textoPequeno">Clasificacion: Tianguis en General<br>Horario: 14hrs a 22 hrs<br>Ubicacion: Bulevar Puerta del Sol 104, Puerta del Sol Reynosa Tamps.</p>
      </div>
    </div>
    <nav>
      <div class="logo">
    ...
    <main>
      <section id="pago">
        <div class="ui link cards" id="tiposLocal">
          <input type="hidden" name="" id="tipoLocalInput" value="none">
          <div class="card desactivado" id="tarjetaNormal" data-content="No disponible" data-position="bottom center" data-variation="inverted">
            <div class="content">
          ...
          <div class="card media desactivado" id="tarjetaClass" data-content="No disponible" data-position="bottom center" data-variation="inverted">
            <div class="content">
          ...
          <div class="card" id="tarjetaUltra" data-content="No disponible" data-position="bottom center" data-variation="inverted">
            <div class="content">
          ...
          <div class="card" id="tarjetaSuper" data-content="No disponible" data-position="bottom center" data-variation="inverted">
            <div class="content">
              <div class="header">Super-ultra</div>
              <div class="description">
                Super-ultra x 30 días
              </div>
            </div>
            <div class="extra content">
              $1000
          ...
          <div class="card" id="tarjetaMaster" data-content="No disponible" data-position="bottom center" data-variation="inverted">
            <div class="content">
          ...
          <div class="card" id="tarjetaPromo" data-content="No disponible" data-position="bottom center" data-variation="inverted">
            <div class="content">
              <div class="header">Promo Diciembre</div>
              <div class="description">
                Promo x 30 días
              </div>
            </div>
            <div class="extra content">
              Contactanos: 834 126 3952
            </div>
          </div>
        </div>
        <div class="ui segment" id="seleccionLocal">
          <div class="wrapperFecha">
            <span>Selecciona la fecha a contratar:</span>
            <div class="ui calendar" id="fechaLocal">
        ...
        <div class="ui segment croquis relative" id="calendarioLocal">
          <svg id="svgCroquis"  viewBox="0 0 1160 260" >
            ...
            <g onClick="prueba(this)" id="66" stroke="#BDBDBD" stroke-width=".5px" fill="white">
            ...
            <g onClick="prueba(this)" id="80" stroke="#BDBDBD" stroke-width=".5px" fill="white">
            ...
            <g id="banio230" stroke="#BDBDBD" stroke-width=".5px" fill="white">
              ...
              <text style="writing-mode: tb;" x="1149" y="215" alignment-baseline="middle" text-anchor="middle" fill="black" stroke="none">baño237</text>
            </g>
          ...
          <div class="indicaciones absolute">
    ...
    <div class="botonComprar" ontouchend="this.onclick=fix">
      <span id="spanNormal">Siguiente</span>
      <i class="arrow right icon" id="normal"></i>
      <span id="spanUltimo">Finalizar</span>
      <i class="shopping basket icon" id="ultimo"></i>
    </div>
    <div class="botonVolver" ontouchend="this.onclick=fix">
    ...
    <script type="text/javascript" src="../../assets/js/rentarJs2.js"></script>
